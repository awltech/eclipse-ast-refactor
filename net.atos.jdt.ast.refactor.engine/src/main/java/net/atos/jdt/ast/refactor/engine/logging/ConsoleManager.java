 ...
 */
package net.atos.jdt.ast.refactor.engine.logging;
...
public class ConsoleManager {
	 ...
	 * Name of the console
	 */
	private static final String CONSOLE_NAME = "AST Refactor Console";
	...
	public void clear() {
		...
		display.asyncExec(new Runnable() {
			...
			public void run() {
				ConsoleManager.this.console.getDocument().set("");
			}
		});
	}

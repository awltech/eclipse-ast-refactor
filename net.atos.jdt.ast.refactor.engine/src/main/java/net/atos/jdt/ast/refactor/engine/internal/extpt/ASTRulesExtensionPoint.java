 ...
 */
package net.atos.jdt.ast.refactor.engine.internal.extpt;
...
import net.atos.jdt.ast.refactor.engine.ASTRuleDescriptor;
import net.atos.jdt.ast.refactor.engine.ASTRulesRepository;
import net.atos.jdt.ast.refactor.engine.IASTRulesDataSource;
...
import net.atos.jdt.ast.refactor.engine.rules.AbstractASTRule;
...
public class ASTRulesExtensionPoint implements IASTRulesDataSource {
	...
	private static final String EXTPT_NAME = "ASTRefactorRules";
		...
		for (final IExtension extension : extensions) {
			for (final IConfigurationElement configurationElement : extension.getConfigurationElements()) {
				if (ASTRulesExtensionPoint.REPOSITORY.equals(configurationElement.getName())) {
					...
					final ASTRulesRepository repository = new ASTRulesRepository(repositoryID);
						...
						try {
							...
							Activator
									...
									.log(new Status(IStatus.WARNING, Activator.PLUGIN_ID,
											RefactorEngineMessages.RULE_LOADING_EXCEPTION.value(contextElement
